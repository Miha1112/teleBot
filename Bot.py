...
P_TIMEZONE = pytz.timezone('Europe/Kiev')
TIMEZONE_COMMON_NAME = 'Kiev'

bot = telebot.TeleBot('1541584229:AAFmNWA4UTsRY3dUg7oBNb_u3WEETr0mH-c')
...
def start_command(message):
    bot.send_message(
        ...
        'Чтобы получить курсы обмена нажмите /exchange.\n' +
        'Чтобы получит помощь нажмите /help.'
    )
...
def help_command(message):
    ...
    keyboard.add(
        telebot.types.InlineKeyboardButton(
            'Написать разработчику', url='telegram.me/DevMiha'
        )
    )
    bot.send_message(
        message.chat.id,
        ...
        '4) Нажмите «Update», чтобы получить актуальную информацию о запросе.. ' +
        'Также бот покажет разницу между предыдущим и текущим курсами обмена..\n' +
        '5) Бот поддерживает inline. Введите @TetsFirstNews_bot в любом чате и первые буквы валюты.',
